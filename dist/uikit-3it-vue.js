      ...
      return e(), n("nav", pe, [
        o("ul", me, [
          ...
          (e(!0), n(_, null, D(a.value, (u, g) => (e(), n("li", {
            ...
            q(s.$slots, u.name, ne({ ref_for: !0 }, u), () => [
  ...
  setup(t, { expose: i, emit: a }) {
    ...
    return T(() => s.input, (y) => {
      ...
      s.floatLeft ? (e(), n("span", Ko, [
        q(y.$slots, "float-left")
      ])) : c("", !0),
      s.floatRight ? (e(), n("span", Uo, [
        q(y.$slots, "float-right")
      ])) : c("", !0)
    ], 2));
  }
}, Go = {

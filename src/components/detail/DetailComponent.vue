      ...
      <div class="col-12">
        <div class="d-flex">
          <div class="flex-shrink-0">
            ...
            >
            <font-awesome-icon icon="fa-solid fa-angle-right" class="eit-font__size--x5 d-none d-lg-block"/>
            <font-awesome-icon icon="fa-solid fa-angle-down" class="eit-font__size--x5 d-lg-none"/>
            </button>
          </div>
...
<style lang="scss">
  ...
  .eit-slide {
    ...
    @include transition('opacity 0.3s ease-in-out, right 0.3s ease-in-out, bottom 0.3s ease-in-out');

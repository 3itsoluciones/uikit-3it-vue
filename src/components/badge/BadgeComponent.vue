...
<template>
  <span :key="`badge-${props.text}`" :class="`eit-badge ${props.className}`">
...
.eit-badge {
  ...
  &__outline {
    ...
    //Corporate
    &--primary {
      border-color: lch(from var(--eit-color-primary) l c h / 0.4);
      background-color: lch(from var(--eit-color-primary) l c h / 0.1);
    }
    &--secondary {
      border-color: lch(from var(--eit-color-secondary) l c h / 0.4);
      background-color: lch(from var(--eit-color-secondary) l c h / 0.1);
    }
    &--tertiary {
      border-color: lch(from var(--eit-color-tertiary) l c h / 0.4);
      background-color: lch(from var(--eit-color-tertiary) l c h / 0.1);
    }

    //Others
    &--green {
      border-color: lch(from var(--eit-color-green) l c h / 0.4);
      background-color: lch(from var(--eit-color-green) l c h / 0.1);
    }
    &--red {
      border-color: lch(from var(--eit-color-red) l c h / 0.4);
      background-color: lch(from var(--eit-color-red) l c h / 0.1);
    }
    &--yellow {
      border-color: lch(from var(--eit-color-yellow) l c h / 0.4);
      background-color: lch(from var(--eit-color-yellow) l c h / 0.1);
    }
    &--blue {
      border-color: lch(from var(--eit-color-blue) l c h / 0.4);
      background-color: lch(from var(--eit-color-blue) l c h / 0.1);
    }
  }
}
</style>
